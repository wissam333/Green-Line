    ...
    >
      <div class="position-sticky">
        <div class="list-group list-group-flush mx-3 mt-4">
          ...
          <RouterLink
            to="/HomeView/ProductsView"
            class="list-group-item list-group-item-action py-2"
            @click="activeTap = 'products'"
            :class="activeTap == 'products' ? 'active' : ''"
          >
            <i class="fas fa-chart-area fa-fw me-3"></i><span>Products</span>
          </RouterLink>
          <RouterLink
            to="/HomeView/PaymentsView"
            @click="activeTap = 'payments'"
            :class="activeTap == 'payments' ? 'active' : ''"
            class="list-group-item list-group-item-action py-2"
            ><i class="fas fa-lock fa-fw me-3"></i><span>Payments</span></RouterLink
          >
        ...
        <ul class="navbar-nav ms-auto d-flex flex-row">
          ...
          <!-- <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
              ...
              <li>
                <a class="dropdown-item" href="#"><i class="flag-syria flag"></i>Arabic</a>
              </li>
            </ul>
          </li>
 -->
